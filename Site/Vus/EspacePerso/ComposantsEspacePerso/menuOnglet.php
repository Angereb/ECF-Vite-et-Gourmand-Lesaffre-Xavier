    ...
    <ul class="liste-onglets">
        ...
        <?php elseif (isset($_SESSION["employe"])): ?>
            ...
            <?php if ($_SESSION["employe"]["administrateur"]): ?>
                <li class="onglet"><a class="onglet-lien" href="?page=espacePerso&onglet=employeAdministrateur" <?= ($onglet === 'employeAdministrateur') ? 'aria-current="page"' : '' ?>>Employés</a></li>
                <li class="onglet"><a class="onglet-lien" href="?page=espacePerso&onglet=statistiqueAdministrateur" <?= ($onglet === 'statistiqueAdministrateur') ? 'aria-current="page"' : '' ?>>Graphiques</a></li>
            <?php endif; ?>
        <?php endif; ?>
    </ul>
</nav>