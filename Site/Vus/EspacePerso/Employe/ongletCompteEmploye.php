...
<section class="zone-onglet-compte">
    <article class="employe-recuperer">
        <h3 class="titre-zone-compte">Votre Compte</h3>
        <form class="formulaire-compte-employe" id="formulaireCompteEmploye" method="post">
            <div class="zone-nom">
                <label for="nomModifierInput" class="label-compte">Nom : </label>
                <input type="text" class="input-compte" id="nomModifierInput" name="nom" value="<?= htmlspecialchars($employe->getNom()) ?>" required>
            </div>
            <div class="zone-prenom">
                <label for="prenomModifierInput" class="label-compte">Prénom : </label>
                <input type="text" class="input-compte" id="prenomModifierInput" name="prenom" value="<?= htmlspecialchars($employe->getPrenom()) ?>" required>
            </div>
            <div class="zone-email">
                <label for="emailModifierInput" class="label-compte">Email : </label>
                <input type="email" class="input-compte" id="emailModifierInput" name="email" value="<?= htmlspecialchars($employe->getEmail()) ?>" required>
            </div>
        ...
        <form class="formulaire-mot-de-passe-employe" id="formulaireMotDePasseEmploye" method="post">
